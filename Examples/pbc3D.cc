...
pbcSortie<<StringCoins;

pbcSortie<<"servo link, "<<NbLinks<<", 0, 1\n";
...
pbcSortie<<ServoLinkString;


//Taking the rest of the filename (boundary conditions, solver parameters, etc... )
do{
getline(InputFile, SortieLine, '\n');
pbcSortie<<SortieLine<<endl;
}while(!InputFile.eof());
...
/* This section is used to put boundary conditions and for output control*/
